      ...
      <section className="saas-section home-testimonials" aria-labelledby="testimonials-title">
        <div className="saas-container">
          ...
          <div className="home-testimonial-grid">{(en ? [
            ...
            { tag: 'Professional services', quote: 'Customer intake and classification are much clearer than before. Employees know exactly whom to prioritize, while managers can easily track progress.', author: 'Trần Quốc Huy', position: 'Head of Sales', company: 'NovaLink Solutions', initials: 'QH', avatar: '/images/homes/home_2.jpg' },
            ...
            { tag: 'Bán lẻ đa kênh', quote: 'Losa giúp đội ngũ gom hội thoại từ nhiều kênh về một nơi. Việc tư vấn ngoài giờ trở nên liền mạch và chúng tôi kiểm soát cơ hội bán hàng tốt hơn.', author: 'Nguyễn Minh Anh', position: 'Giám đốc vận hành', company: 'An Nhiên Retail', initials: 'MA', avatar: '/images/homes/home_1.webp' },
            { tag: 'Dịch vụ chuyên nghiệp', quote: 'Quy trình tiếp nhận và phân loại khách hàng rõ ràng hơn trước. Nhân viên biết chính xác cần ưu tiên ai và quản lý dễ dàng theo dõi tiến độ xử lý.', author: 'Trần Quốc Huy', position: 'Trưởng phòng Kinh doanh', company: 'NovaLink Solutions', initials: 'QH', avatar: '/images/homes/home_2.jpg' },
            { tag: 'Chăm sóc khách hàng', quote: 'Các kịch bản nhắc lịch và chăm sóc sau dịch vụ giúp trải nghiệm khách hàng nhất quán hơn mà đội ngũ không phải tăng thêm khối lượng công việc thủ công.', author: 'Lê Thảo Nguyên', position: 'Nhà sáng lập', company: 'Mộc An Wellness', initials: 'TN', avatar: '/images/homes/home_3.jpg' }
          ]).map((item) => (
